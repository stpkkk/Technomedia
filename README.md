...
<div>
 <p>Тестовое задание на должность Frontend-разработчика в компании Техномедия с использование фреймворка React.js.
Реализовано одностраничное веб-приложение с тремя карточками: статьи, курсы и медия, каждая карточка содержит сторисы, по нажатию на тайтл сториса открывается одноименная статья, курс или медия.</p>
